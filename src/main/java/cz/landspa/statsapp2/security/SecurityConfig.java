package cz.landspa.statsapp2.security;

import cz.landspa.statsapp2.security.CustomAuthenticationProvider;
import cz.landspa.statsapp2.util.CustomAuthenticationFailureHandler;
import cz.landspa.statsapp2.util.DevAutoLoginFilter;
import cz.landspa.statsapp2.util.JwtUtil;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain apiFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers(HttpMethod.POST,"/api/login-session").permitAll()
    ...
    public SecurityFilterChain webFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(requests -> requests
                        .requestMatchers("/css/**", "/img/**", "/js/**", "/svg/**", "/test","/print/**", "/fonts/**","/old/**").permitAll()
